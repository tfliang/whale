...
BASE_PATH= '/Users/sid/data/whale'
TRAIN_DF = BASE_PATH + '/train.csv'
SUB_Df = BASE_PATH + '/sample_submission.csv'
TRAIN = BASE_PATH + '/train/'
TEST = BASE_PATH + '/test/'

P2H = '/Users/sid/PycharmProjects/whale/data/metadata/p2h.pickle'
P2SIZE = '/Users/sid/PycharmProjects/whale/data/metadata/p2size.pickle'
BB_DF = "/Users/sid/PycharmProjects/whale/data/metadata/bounding_boxes.csv"

Piotte_standard = '/Users/sid/PycharmProjects/whale/data/piotte/mpiotte-standard.model'
Piotte_bootstrap = '/Users/sid/PycharmProjects/whale/data/piotte/mpiotte-bootstrap.model'
